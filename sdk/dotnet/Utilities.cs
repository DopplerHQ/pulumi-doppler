...
namespace Pulumiverse.Doppler
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/DopplerHQ";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Doppler.version.txt");
    ...
    internal sealed class DopplerResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DopplerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
